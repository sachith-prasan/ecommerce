...
@section('main')
    ...
    <section class="shop-checkout container">
        ...
        <form name="checkout-form" action="https://uomo-html.flexkitux.com/Demo23/shop_order_complete.html">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="ship_different_address">SHIP TO A DIFFERENT
                                    ADDRESS?</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sticky-content">
                        ...
                        <div class="checkout__payment-methods">
                            ...
                            <div class="policy-text">
                                ...
                                this website, and for other purposes described in our <a href="terms.html"
